...
- **Containers and Kubernetes:**
    ...
    - [What's new in Azure Container Apps at Build 2026](https://techcommunity.microsoft.com/blog/appsonazureblog/whats-new-in-azure-container-apps-at-build26/4524184)  
      *Latest updates and features for Azure Container Apps announced at Build 2026.*
...
- **Models, speech, content, and R&D:**
    - [Seven new First-Party Microsoft AI models](https://microsoft.ai/news/building-a-hillclimbing-machine-launching-seven-new-mai-models/)  
      *MAI-Thinking-1, MAI-Code-1-Flash, MAI-Image-2.5, MAI Transcribe-1.5, MAI-Voice-2*
